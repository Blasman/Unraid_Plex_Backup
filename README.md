# Unraid_Plex_Backup
A user script for Unraid to backup only the essential Plex data. There are two users scripts that are similar yet have key differences. Choose either or both depending on your needs.
